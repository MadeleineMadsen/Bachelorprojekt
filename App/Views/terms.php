<main class="main-terms">
    ...
    <section class="terms-section">
        ...
        <p class="terms-text">
            <strong>
                De oplysninger der behandles kan inkludere:
            </strong>
        </p>
    ...
    <section class="terms-section">
        ...
        <p class="terms-text">
            ...
            deltage i events, ansøge om medlemskab og interagere med andre brugere.
        </p>

        <p class="terms-text">
            Brugeren er ansvarlig for, at de oplysninger og det indhold der deles på
        ...
        <p class="terms-text">
            GBG Social forbeholder sig retten til at fjerne indhold, afvise medlemsansøgninger
